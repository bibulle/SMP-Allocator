...
public class Fill_03 extends Fill {


	static {
		for (int i = 0; i < MaterialData.SLABS.length; i++) {
			for (int j = 0; j < MaterialData.PILARS.length; j++) {
				addFillType(new Fill_03(i, j));
			}
		}
	}

	public Fill_03(int slab, int pilar) {
		super(3, slab, pilar);
	...
	private MaterialData[][] LEVEL_2 = { { MaterialData.AIR, MaterialData.AIR, MaterialData.AIR }, { MaterialData.AIR, MaterialData.AIR, MaterialData.AIR }, { MaterialData.AIR, MaterialData.AIR, MaterialData.AIR }, { MaterialData.AIR, MaterialData.AIR, MaterialData.AIR }, { MaterialData.AIR, MaterialData.AIR, MaterialData.AIR }, { MaterialData.AIR, MaterialData.AIR, MaterialData.AIR }, };
